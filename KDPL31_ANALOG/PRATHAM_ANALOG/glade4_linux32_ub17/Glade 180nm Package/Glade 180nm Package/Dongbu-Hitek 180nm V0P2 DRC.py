...
geomArea(PIMP,0.3844,999,"7A7a:min. area of PIMP must be o.3844 um2 ")
...
geomWidth(geomAnd(POLY,SAB), 0.42, "47W47b  :POLY width > 0.42")
...
geomSpace(MET2,0.60,10,0,"12S12b  : min. space between M2 lines with one or both M1 line width are greater than 10um must be 0.60um")
...
geomSpace(MET3,0.60,10,0,"14S14b  : min. space between M3 lines with one or both M3 line width are greater than 10um must be 0.60um")
...
geomAllowedWidths(VIA3,[0.26])
geomArea(VIA3,0.0676,0.068,"11W11a:WIdth of VIA3 should be 0.26um in all sides") 
geomSpace(VIA3,0.26,0,"11S11a:Min Space between VIA3 is 0.26um ") 
saveDerived(geomAndNot(geomOverlapping(MET3,VIA3),MET3),"11E10a :Overlap of a MET3 and VIA3 is not allowed")
geomEnclose(MET3,geomAnd(MET3,VIA3),0.01,"11E10a:Min Enclosure of VIA3 by MET3 must be 0.01um")
saveDerived(geomCoincident(MET3,VIA3),"11E10a:MET3 and VIA3 should not coincide")
...
geomSpace(MET4,0.60,10,0,"16S16b  : min. space between M4 lines with one or both M4 line width are greater than 10um must be 0.60um")
...
geomSpace(MET5,0.60,10,0,"18S18b  : min. space between M5 lines with one or both M5 line width are greater than 10um must be 0.60um")
...
geomAllowedWidths(VIA5,[0.26])
geomArea(VIA5,0.0676,0.068,"19W19a:WIdth of VIA5 should be 0.26um in all sides") 
...
geomSpace(MET6,0.60,10,0,"20S20b  : min. space between M6 lines with one or both M6 line width are greater than 10um must be 0.60um")
